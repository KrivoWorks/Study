...
// специальные объекты (комплексные): Массивы, Функции, Объекты даты, Регулярные выражения, Ошибки
// объект - это структура для хранения данных (свойств объекта)
const testTwo = {
    name: "Roman", // name - свойство (ключ), "Roman" - метод (значение)
    age: 29, // свойство и метод разделяются :
    isMarried: true // у последнего свойства, вконце - запятая не ставится
};
...
const testThreeB = []; 
testThreeB[0] = "text"; // можно не только получить элемент из массива но и записать его
...
console.log(typeof(testFourD)); // получаем результат - числовой тип данных
...
// унарный плюс, в примере выше переводит строку в число
...
// = присваивание, == равенство по значению, === равенство по типу данных
