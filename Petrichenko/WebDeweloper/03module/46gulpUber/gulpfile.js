...
// browserSync
// если запустить сервер, в адресной строке будет прописано localhost:3000
// если прописать localhost:3001 - откроется панель администратора
// в окне Overview в разделе External будет адрес
// по которому можно пройти на устройстве находящемся в той же Wi Fi сети и получить доступ к сайту

// при запуске с другого компьютера возможно потребуется разрешить доступ
// в PwerShell нужно прописать - Set-ExecutionPolicy RemoteSigned
// и подтвердить - Y