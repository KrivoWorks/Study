...
// собитие произошло и нам нужно чтобы с элементом больше нельзя было взаимодействовать
...
// вторым аргументом идёи callbzck функция 
    alert("Click");
...
// одни из свмых важных свойств это "type" - тип события который произошёл и target - элемент на котором произошло событие
